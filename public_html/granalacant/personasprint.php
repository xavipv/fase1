...
$pdf->SetAuthor('Xavi');
$pdf->SetTitle('Listado de personas');
$pdf->SetSubject('Personas');
$pdf->SetKeywords('personas, listado');

// set default header data
$pdf->SetHeaderData(PDF_HEADER_LOGO, PDF_HEADER_LOGO_WIDTH, PDF_HEADER_TITLE . " - Listado de personas (" . date("d-m-Y") . ")", PDF_HEADER_STRING);
...
$pdf->Output("listadopersonas.pdf", 'I');
