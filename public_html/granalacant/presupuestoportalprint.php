...
$pdf->SetAuthor('Xavi');
$pdf->SetTitle('Presupuesto portal');
$pdf->SetSubject('Cuotas');
$pdf->SetKeywords('presupuesto, portal, cuotas, calculo, mensual');

// set default header data
$pdf->SetHeaderData(PDF_HEADER_LOGO, PDF_HEADER_LOGO_WIDTH, PDF_HEADER_TITLE . " - Cuotas presupuesto (" . date("d-m-Y") . ")", PDF_HEADER_STRING);
...
$pdf->Output("listadopresupuestoportal.pdf", 'I');
