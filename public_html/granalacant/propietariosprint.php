...
$pdf->SetSubject('Propietarios');
$pdf->SetKeywords('propietarios, apartamentos, listado');

// set default header data
$pdf->SetHeaderData(PDF_HEADER_LOGO, PDF_HEADER_LOGO_WIDTH, PDF_HEADER_TITLE . " - Listado de propietarios (" . date("d-m-Y") . ")", PDF_HEADER_STRING);
...
$pdf->Output("listadopropietarios.pdf", 'I');
